 ...
 * <p>
 * You will receive the following data structure representing the stairs Suzuki logged in a year. You will have all
 * data for the entire year so regardless of how it is logged the problem should be simple to solve.
 * <p>
 ...
 * 7555, 7682, 5252, 8793, 8837, 7320, 8478, 6063, 5751, 9716, 5085, 7315, 7859, 6628, 5425, 6331, 7097, 6249,
 * 8381, 5936, 8496, 6934, 8347, 7036, 6421, 6510, 5821, 8602, 5312, 7836, 8032, 9871, 5990, 6309, 7825]
 * Your function should return the 20 year estimate of the stairs climbed using the formula above.
 */
public class Kata {
    public static long stairsIn20(int[][] stairs) {
        return Arrays.stream(stairs)
            .map(item -> Arrays.stream(item).reduce(0, Integer::sum))
