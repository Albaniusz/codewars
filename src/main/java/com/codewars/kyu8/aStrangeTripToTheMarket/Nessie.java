 ...
 * together like you wouln't believe as the musician puts together patterns of tunes. As you wonder what kind
 * of algorithm you could use to shift octaves by 8 pitches or something silly like that, it dawns on you that you
 * have been watching the musician for some 10 odd minutes. You ask, "how much do people normally tip for something
 * like this?" The artist looks up. "It's always gonna be about tree fiddy."
 * <p>
 ...
 * The Loch Ness Monster. Note that the phrase can also be written as "3.50" or "three fifty". Your function should
 * return true if you're talking with The Loch Ness Moster, false otherwise.
 */
public class Nessie {
