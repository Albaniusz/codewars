package com.codewars.kyu8.collinearity;

/**
 * <h4>Theoretical Material</h4>
 ...
 * <img src="https://d138zd1ktt9iqe.cloudfront.net/media/seo_landing_files/collinear-vectors-1627481628.png"/>
 * <p>
 ...
 * <h4>Notes</h4>
 * <ul>
 * <li>All vectors start from the origin (x=0, y=0).</li>
 * <li>Be careful when handling cases where x1, x2, y1, or y2 are zero to avoid division by zero errors.</li>
 * <li>A vector with coordinates (0, 0) is collinear to all vectors.</li>
 * </ul>
 * <h4>Examples</h4>
 * <pre>
 * (1,1,1,1) ➞ true
