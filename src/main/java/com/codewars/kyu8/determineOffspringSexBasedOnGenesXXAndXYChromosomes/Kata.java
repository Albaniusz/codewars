package com.codewars.kyu8.determineOffspringSexBasedOnGenesXXAndXYChromosomes;

/**
 * The male gametes or sperm cells in humans and other mammals are heterogametic and contain one of two types
 * of sex chromosomes. They are either X or Y. The female gametes or eggs however, contain only the X sex chromosome
 * and are homogametic.
 * <p>
...
public class Kata {
    public static String chromosomeCheck(String sperm) {
        return String.format("Congratulations! You're going to have a %s.", sperm.contains("Y") ? "son" : "daughter");
    }
}
